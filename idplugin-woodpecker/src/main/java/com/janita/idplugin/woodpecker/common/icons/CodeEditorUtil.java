...
public class CodeEditorUtil {
    ...
    public static void setCode(Project project, Editor editor, String code) {
        ...
        Runnable runnable = () -> document.replaceString(0, textLength, ObjectUtils.defaultIfNull(code, ""));
        Runnable action = () -> WriteCommandAction.runWriteCommandAction(project, runnable);
